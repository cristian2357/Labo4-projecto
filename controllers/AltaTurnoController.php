...
if (isset($_GET['empresa']) && !isset($_POST['puntoEntrada'])) {
	...
	if (!isset($_POST['idEmpresa']) || !isset($_POST['idSucursal']))
		throw new AltTurException("Faltan valores en la peticion con punto de entrada H");
	...
	if (!isset($_POST['idEmpresa']) || !isset($_POST['idSucursal']) || !isset($_POST['fecha']))
		throw new AltTurException("Faltan valores en la peticion con punto de entrada J");
	...
	if (!isset($_POST['idEmpresa']) || !isset($_POST['dni']))
		throw new AltTurException("Faltan valores en la peticion con punto de entrada L");
...
class AltTurException extends Exception {}
