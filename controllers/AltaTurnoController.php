...
if (isset($_GET['empresa']) && !isset($_POST['puntoEntrada'])) {
	...
	if (!isset($_POST['idEmpresa']) || !isset($_POST['idSucursal']))
		throw new DefaultException("Faltan valores en la peticion con punto de entrada H");
	...
	if (!isset($_POST['idEmpresa']) || !isset($_POST['idSucursal']) || !isset($_POST['fecha']))
		throw new DefaultException("Faltan valores en la peticion con punto de entrada J");
	...
	if (!isset($_POST['idEmpresa']) || !isset($_POST['dni']))
		throw new DefaultException("Faltan valores en la peticion con punto de entrada L");
